...
const AppointmentInfo =({onAppointmentSelected, onShowModal, appointment, onDeleteAppointment}) =>{

return(
<li onClick={()=> {onAppointmentSelected(appointment); onShowModal()}} className="px-3 py-3 flex items-start">
